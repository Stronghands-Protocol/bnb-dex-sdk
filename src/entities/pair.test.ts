...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(1, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 18, 'USDC', 'USD Coin')
    const tokenB = new Token(1, '0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3', 18, 'DAI', 'DAI Stablecoin')
    const result = computePairAddress({
      factoryAddress: '0x2C3408a4827DF0419DA2f53eAe92f338B4d314ec',
      tokenA,
      tokenB
    })

    expect(result).toEqual('0x665D2176329Be9A3062796b3AEd6FD8075a69F13')
  })
  it('should give same result regardless of token order', () => {
    const USDC = new Token(1, '0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d', 18, 'USDC', 'USD Coin')
    const DAI = new Token(1, '0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3', 18, 'DAI', 'DAI Stablecoin')
    let tokenA = USDC
    let tokenB = DAI
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x665D2176329Be9A3062796b3AEd6FD8075a69F13')
    })
  })
